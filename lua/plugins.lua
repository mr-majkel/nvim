...
return require('packer').startup(function()
  ...
  use {'neovim/nvim-lspconfig', event="BufReadPost", config=function() require("mm.plugins.nvim_lsp") end, requires={
  ...
  -- wiki and md
  use {'vimwiki/vimwiki', ft="markdown", event="CursorHold", after="vim-pandoc", setup=function() require("mm.plugins.vimwiki") end}
